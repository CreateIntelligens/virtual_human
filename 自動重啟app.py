...
def build_nerfreal(sessionid):
    ...
    nerfreal.opt.TTS_SERVER = 'http://52.69.235.212:9880/test' if actual_voice_type == 1 else 'http://52.69.235.212:9880/'
...
async def switch_tts_endpoint(request):
    ...
    nerfreal.opt.TTS_SERVER = 'http://52.69.235.212:9880/test' if config_type == 1 else 'http://52.69.235.212:9880/'
