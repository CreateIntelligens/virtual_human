...
### 2.3 檔案結構改變
1. 原始 rtcpush 實現 (2025/04 之前)：
   - 主要檔案：web/rtcpushapi.html (2025/03/15)
   - 相關檔案：
     - rtcpushapi_google.html (2025/03/20, Google STT 版本)
     - rtcpushapi_demo.html (2025/03/25, 示範版本)
     - rtcpushapi_google_test.html (2025/04/01, 測試版本)
     - rtcpushapi_google_old.html (2025/04/10, 舊版備份)
     - rtcpushapi_google_green.html (2025/04/15, 綠幕版本)

2. 新版 webrtc 實現 (2025/04/29 開始)：
   - 主要檔案：web/webrtcapi_no_condition.html (2025/04/29)
   - 分割版本：
     - webrtcapi_no_condition_part1.html (2025/04/29, 樣式)
     - webrtcapi_no_condition_part2.html (2025/04/29, HTML結構)
     - webrtcapi_no_condition_part3.html (2025/04/29, JavaScript代碼)
   - 相關檔案：
     - webrtcapi_demo.html (2025/04/29, 新版示範)
     - webrtcapi.html (2025/04/29, 基礎版本)
